...
// This is actually pretty nice in terms of learnign syntax: 
...
/* --------- I understand now, --> Just make this whole thing work but first 
        1. Make a LinkedCircularQueue Class that satifies the CircularQueue interface!!
--------- */ 
...
//      public static <E> CircularQueue<E> buildQueue(E a[ ]) {
//      <E> queue = new CircularlyLinkedList<>();
//      for (int i=0; i<a.length; i++)
//     queue.enqueue(a[i]);
//      return queue;
//      }
